      ...
      <div style={{ maxWidth: 1200, margin: "0 auto 20px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <button
              onClick={() => { const opening = !showForm; setShowForm(v => !v); setEditingId(null); setForm({ product_id: "", location_id: "", transaction_type: "inward", quantity: "", party: "", notes: "" }); if (opening) fetchDropdowns(); }}
